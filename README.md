Currently copied straight from my copy. There are many things that need to be cleaned up, including some directories which are currently harded in. Besides those this should work at least somewhat.
